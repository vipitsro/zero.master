...
$this->title = Yii::t("main", 'Suppliers Home');
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group" style="display: inline-block;/*text-align: right;*/">
                <?= Html::a(Yii::t("main", 'Create'), ['home-create'], ['class' => 'btn btn-success']) ?>
            </div>
        </div>
            ...
            [
                ...
                'buttons' => [
                    'update' => function ($url, $model) {     
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Url::to(["home-update", "id" => $model->id]), [
