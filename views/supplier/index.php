...
$this->title = Yii::t("main", 'Suppliers');
...
<div class="supplier-index">
    ...
    <div class="row">
        ...
        <div class="col-md-12 advanced-search" style="height: 1px; overflow: hidden;">
            ...
            <div class="col-md-3">
                <?= $form->field($searchModel, 'account_prefix')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'account_number')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'bank_code')->textInput() ?>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <?= $form->field($searchModel, 'ks')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'typical_service')->textInput() ?>
            </div>
        </div>
