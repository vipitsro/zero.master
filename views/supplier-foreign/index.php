...
<div class="supplier-index">
    ...
    <div class="row">
        ...
        <div class="col-md-12 advanced-search" style="height: 1px; overflow: hidden;">
            ...
            <div class="col-md-3">
                <?= $form->field($searchModel, 'swift')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'iban')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'address_street')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'address_city')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'address_country')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'bank_name')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'bank_street')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'bank_city')->textInput() ?>
            </div>
            <div class="col-md-3">
                <?= $form->field($searchModel, 'bank_country')->textInput() ?>
            </div>
        </div>
